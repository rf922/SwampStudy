   ...
   // console.log(JSON.stringify(team));
    return (
        <div className='h-full w-full bg-slate-800 p-4'>
            <p className="text-3xl text-center text-white mb-4">About Seal Team One</p>
            <div className="flex flex-wrap justify-center items-center gap-4">
                {Object.keys(team).map((name, index) => (
                    ...
                    >
                        ...
                        <h1
                            className="text-white text-center border-2 border-white p-2 rounded transition-colors hover:bg-white hover:text-slate-800"
                        >
                            {team[name].name}
                        </h1>
                    </div>
